      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-100 dark:border-gray-700">
            ...
            <h2 className="text-2xl font-semibold mb-2 dark:text-white">Bots Discord</h2>
            <p className="text-gray-600 dark:text-gray-300">
              Création de bots Discord personnalisés avec des fonctionnalités avancées,
              notamment pour la gestion de musique et l'administration de serveur.
            </p>
          </div>

          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-100 dark:border-gray-700">
            <Box className="w-12 h-12 text-blue-600 dark:text-blue-400 mb-4" />
            <h2 className="text-2xl font-semibold mb-2 dark:text-white">Plugins Minecraft</h2>
            <p className="text-gray-600 dark:text-gray-300">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-100 dark:border-gray-700">
          <h2 className="text-2xl font-semibold mb-6 dark:text-white">Compétences Techniques</h2>
          {skills.map((skill) => (
